        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          <div id="portfolio" className="space-y-10">
            <div className="flex items-end justify-between border-b-2 border-black pb-4">
              ...
              <Link to="/portfolio" className="text-[11px] font-bold uppercase tracking-[0.3em] text-zinc-400 hover:text-black transition-all pb-1">
                View All →
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {previewProjects.map((project, index) => (
                <Link to="/portfolio" key={index} className="group block">
                  <div className="relative aspect-video (16/9) overflow-hidden bg-zinc-100 border border-black/5">
                    <img
                      src={project.image}
                      alt={project.title}
          ...
          <div id="services" className="space-y-10">
            <div className="flex items-end justify-between border-b-2 border-black pb-4">
              ...
              <Link to="/services" className="text-[11px] font-bold uppercase tracking-[0.3em] text-zinc-400 hover:text-black transition-all pb-1">
                Services →
              </Link>
            </div>
