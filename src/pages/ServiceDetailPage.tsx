    ...
    return (
      <div className="min-h-screen bg-white pt-24 pb-16 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl text-black mb-4">Service Not Found</h1>
          <Link to="/services" className="text-black/60 hover:text-black">
            ← Back to Services
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-white pt-24 pb-16">
      <div className="max-w-5xl mx-auto px-6">
        <Link to="/services" className="inline-flex items-center gap-2 text-black/60 hover:text-black transition-colors mb-12">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-5xl md:text-7xl text-black mb-6 font-light">{service.title}</h1>
          <p className="text-black/70 text-xl font-light leading-relaxed">
            {service.description}
          </p>
        </div>

        <div className="bg-gray-50 border border-black/10 rounded-sm p-8 md:p-12 mb-12">
          <h2 className="text-3xl text-black mb-6 font-light">What We Offer</h2>
          <ul className="space-y-4">
            {service.features.map((feature, idx) => (
              <li key={idx} className="flex items-start gap-4">
                <span className={`${iconClasses.bullet} mt-1.5 text-xl`}>•</span>
                <span className="text-black/70 text-lg">{feature}</span>
              </li>
            ))}
          </ul>
        </div>
