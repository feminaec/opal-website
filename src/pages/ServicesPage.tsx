...
export default function ServicesPage() {
  return (
    ...
    */
    <div className="h-[calc(100vh-100px)] bg-white overflow-hidden flex flex-col mb-[100px] animate-fade-in">
      
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 w-full h-full flex flex-col pt-32 pb-6">
        ...
        <div className="mt-4 pt-4 border-t-2 border-black flex justify-between items-center">
          <div className="flex flex-col">
            <p className="text-[9px] uppercase tracking-[0.4em] text-zinc-400 font-bold">
              Next Step
            </p>
          ...
          <Link 
            ...
            className="group inline-flex items-center justify-center px-8 py-3 bg-black text-white text-[10px] font-bold uppercase tracking-[0.3em] transition-all duration-300 hover:bg-zinc-800"
          >
            Start Project
