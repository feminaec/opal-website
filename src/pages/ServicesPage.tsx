  ...
  return (
    <div className="min-h-screen bg-black pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16">
          <h1 className="text-5xl md:text-7xl text-white mb-6 font-light">Our Services</h1>
          ...
          {services.map((service) => {
            ...
            return (
              <Link
                ...
                className={`group relative overflow-hidden rounded-sm bg-gradient-to-br ${gradientClasses} border border-white/5 hover:border-${service.color}-500/30 transition-all duration-500 p-8`}
              >
