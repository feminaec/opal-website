        ...
        <div className="border-b-2 border-black pb-6 sm:pb-8 mb-8 sm:mb-12">
          <div className="flex flex-col md:flex-row justify-between items-end gap-4">
            <div className="space-y-2">
              ...
              <h1 className="text-4xl sm:text-6xl md:text-[90px] font-black uppercase tracking-tighter text-black leading-[0.8]">
                Our Work
              </h1>
            </div>
            <p className="text-black text-xs sm:text-sm uppercase font-black tracking-wider leading-tight max-w-[280px] md:text-right pb-2">
              ...
              >
                ...
                <div className="mt-6 flex flex-col space-y-4">
                  <div className="flex justify-between items-start">
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-black uppercase tracking-tighter text-black leading-none">
                      {project.title}
                    </h3>
                  ...
                  <div className="flex justify-between items-center border-t-2 border-black pt-4">
                    ...
                    <div className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.15em] text-black border-b-2 border-black pb-0.5 transition-all">
