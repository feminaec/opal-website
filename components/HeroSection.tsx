...
export default function HeroSection({ onNavigate }: HeroSectionProps) {
  return (
    <div id="home" className="relative h-screen flex items-center justify-center pt-20 md:pt-0">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button className="group relative px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-black font-medium rounded-sm overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-amber-500/50">
