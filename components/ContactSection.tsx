    ...
    <div id="connect" className="relative z-10 bg-gradient-to-b from-black via-gray-900 to-black py-24">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
          ...
          <div>
            <p className="text-white/40 uppercase tracking-wider mb-2">Phone</p>
            <p className="text-white/80">+971 XX XXX XXXX</p>
          </div>
          <div>
        ...
        <div className="mt-12 flex justify-center gap-6">
          <a href="#" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:text-white hover:border-white/40 transition-all duration-300">
